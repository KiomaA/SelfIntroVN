...
## init offset 語句導致此文件中的初始化語句在任何其他文件中的 init 語句之前運
## 行。
init offset = -2
...
## 用於遊戲內文字的字形
define gui.text_font = "NotoSansTC-Light.ttf"

## 用於角色名稱的字形
define gui.name_text_font = "NotoSansTC-Light.ttf"

## 用於遊戲外文本的字形
define gui.interface_text_font = "NotoSansTC-Light.ttf"
...
## 文本框在螢幕上垂直的位置。0.0 是頂部，0.5 是中心，1.0 是底部
...
## 按鈕 ##########################################################################
##
## 這些變數與 gui/button 中的圖像檔案一起控制按鈕顯示方式的各個方面
...
## 如果為 True ，背景圖像將平鋪。如果為 False ，背景圖像將線性縮放
...
## 這些控制條、捲軸和滑塊的外觀和大小
##
## 預設 GUI 僅使用滑塊和垂直滾動條。所有其他捲軸僅在創建者編寫的螢幕中使用
