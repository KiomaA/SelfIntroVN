...
define config.name = _("Kioma Avalon Self-intro VN")
...
define config.save_directory = "kiomadebut-1746634509"
...
## 構置配置 ########################################################################
##
## 本節控制Ren'Py如何將您的專案轉換為釋出版。

init python:

    ## 以下函數採用檔案模式。 檔案模式不區分大小寫，並與相對於基底目錄的路徑進行
...
## 執行應用程式內購買需要 Google Play 許可證密鑰。它可以在 Google Play 開發者控
## 制台的 "Monetize" > "Monetization Setup" > "Licensing" 下找到。

# define build.google_play_key = "..."


## 與 itch.io 項目關聯的使用者名稱和項目名稱，以斜線分隔。
